...
map.getView().fit([685675.155253, 8964739.634617, 693047.832151, 8969876.202918], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">COUNCIL PLOTS FOR SALE - NCHELENGE</h2>';
        return titleElement;
    })(),
